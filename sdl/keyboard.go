...
const (
	KModNone     = C.KMOD_NONE
	KModLShift   = C.KMOD_LSHIFT
	KModRShift   = C.KMOD_RSHIFT
	KModLCtrl    = C.KMOD_LCTRL
	KModRCtrl    = C.KMOD_RCTRL
	KModLAlt     = C.KMOD_LALT
	KModRAlt     = C.KMOD_RALT
	KModLGui     = C.KMOD_LGUI
	KModRGui     = C.KMOD_RGUI
	KModNum      = C.KMOD_NUM
	KModCaps     = C.KMOD_CAPS
	KModMode     = C.KMOD_MODE
	KModCtrl     = C.KMOD_CTRL
	KModShift    = C.KMOD_SHIFT
	KModAlt      = C.KMOD_ALT
	KModGui      = C.KMOD_GUI
